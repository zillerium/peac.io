...
const initData = {
    ...
    heading: "For Sale",
    content: "These products are for sale",
    btnText: "Load More"
}
...
class AuctionsTwo extends Component {
    ...
    componentDidMount(){
        console.log("mount is done now ---- 2")
        this.setState({
            initData: initData,
            data: data
        })
    }
    // data object is read in total and idx used to display segments of the data
    render() {
          console.log("start of 2 " + JSON.stringify(this.state.data))
        return (
